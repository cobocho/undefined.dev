  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2">
        <a href="https://resume.un-defined.dev" target="_blank">
          <button className="flex cursor-pointer items-center gap-2 rounded-md border bg-blue-500 px-4 py-2 text-sm text-white">
